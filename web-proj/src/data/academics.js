export const academicData = [
        ...
        subjects: [
          {
            ...
            desc: 'OOP concepts — classes, inheritance, polymorphism, interfaces, exception handling, and Java collections.',
          },
          {
          ...
          },
          {
            ...
            desc: 'SDLC models, requirements engineering, UML, testing strategies, and project management.',
          },
        ],
      },
      {
  ...
  },
  {
    ...
    semesters: [
      {
        sem: 1,
        label: 'Subjects Studied (PCMB)',
        subjects: [
          {
            name: 'Physics',
            desc: 'Mechanics, thermodynamics, waves, optics, electrostatics, current electricity, and modern physics.',
          },
          {
            name: 'Chemistry',
            desc: 'Atomic structure, chemical bonding, thermodynamics, electrochemistry, organic reactions, and polymers.',
          },
          {
            name: 'Mathematics',
            desc: 'Relations & functions, trigonometry, calculus, vectors, 3D geometry, and probability.',
          },
          {
            name: 'Biology',
            desc: 'Cell biology, genetics, evolution, ecology, human physiology, plant biology, and biotechnology.',
          },
        ],
      },
    ],
    ...
    semesters: [
      {
        ...
        subjects: [
          {
            name: 'First Language (Kannada)',
            desc: 'Kannada grammar, prose, poetry, comprehension, and writing skills.',
          },
          {
            name: 'Second Language (English)',
            desc: 'English grammar, reading comprehension, creative writing, and language proficiency.',
          },
          {
            name: 'Third Language (Hindi)',
            desc: 'Hindi grammar, prose, poetry, and basic communication skills.',
          },
          {
            name: 'Mathematics',
            desc: 'Arithmetic, algebra, geometry, mensuration, statistics, and introductory trigonometry.',
          },
          {
            name: 'Science',
            desc: 'Physics, chemistry, and biology fundamentals — forces, matter, life processes, and natural phenomena.',
          },
          {
            name: 'Social Science',
            desc: 'History of India & world, geography, political science, and economics.',
          },
        ],
      },
    ],
